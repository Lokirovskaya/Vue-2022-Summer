                ...
                <div style="text-align: right">
                    <el-dropdown>
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item>
                                <div @click="edit_prototype(item.proto_id)">编辑原型图</div>
                            </el-dropdown-item>
                            <el-dropdown-item>
                                <div @click="prototype_rename_dialog_visible = true; prototype_rename_id = item.proto_id;">重命名</div>
                            </el-dropdown-item>
                            <el-dropdown-item style="color: red">
                                <div @click="delete_prototype(item.proto_id)">删除原型图</div>
                            </el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                </div>
    ...
    methods: {
        ...
        rename_prototype() {
            ...
            if (this.prototype_rename === '') {
                ...
                this.$axios.post('/project/rename_proto', qs.stringify({ proto_id: this.prototype_rename_id, new_name: this.prototype_rename }), {
                    headers: {
        ...
        delete_prototype(prototype_id) {
            this.$confirm('是否删除文档？', '删除文档', {
                ...
                this.$axios.post('/project/delete_proto', qs.stringify({ proto_id: prototype_id }), {
                    headers: {
                        userid: this.$store.state.userid,
                        token: this.$store.state.token,
                    }
