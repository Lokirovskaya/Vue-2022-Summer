        ...
        <div style="margin-left: 30%; margin-right: 30%">
          ...
          <span style="position: relative; top: 30px">
            ...
            <el-input
              type="textarea"
              placeholder="请输入内容"
              v-model="input_proj_info"
              maxlength="150"
              show-word-limit
              style="position: relative; bottom: -5px"
            >
            </el-input>
            <el-button style="position: relative; top: 10px" @click="EditProjInfo">修改</el-button> </span
          ><br />
        </div>
      </div>
      <!--分割线-->
